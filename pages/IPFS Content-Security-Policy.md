...
- This is not a a new problem and web platform had developed solution in form of [As per MDN](https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Content-Security-Policy)