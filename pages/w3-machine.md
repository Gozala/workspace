...
- Ok for this to be of any use we'll need to define some more instructions. Some obvious one would be to represent [[leveldown]] API in terms of [[UCAN Invocation]]s. But any non trivi  also want some control flow instructions