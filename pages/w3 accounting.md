...
- > You could potentially build something like that by introducing hierarchical addressing e.g. `did:key:zAlice:/bafy...session`, but then again hierarchies come with complexity and no clear benefit